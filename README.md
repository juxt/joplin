...
```clojure
:dependencies [[joplin.core "0.2.10"]]
```

If you want to integrate Joplin into Leiningen:

```clojure
:plugins [[joplin.lein "0.2.10"]]
```
...
```clojure
:dependencies [[joplin.cassandra "0.2.10"]
               [joplin.datomic "0.2.10"]
               [joplin.elasticsearch "0.2.10"]
               [joplin.hive "0.2.10"]
               [joplin.jdbc "0.2.10"]
               [joplin.zookeeper "0.2.10"]]
```
