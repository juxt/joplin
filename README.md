...
```clojure
:dependencies [[joplin.core "0.2.3"]]
```

If you want to integrate Joplin into Leiningen:

```clojure
:plugins [[joplin.lein "0.2.3"]]
```
...
```clojure
:dependencies [[joplin.cassandra "0.2.3"]
               [joplin.datomic "0.2.3"]
               [joplin.elasticserch "0.2.3"]
               [joplin.hive "0.2.3"]
               [joplin.jdbc "0.2.3"]
               [joplin.zookeeper "0.2.3"]]
```
