...
```clojure
:dependencies [[joplin.core "0.2.18"]]
```

If you want to integrate Joplin into Leiningen:

```clojure
:plugins [[joplin.lein "0.2.18"]]
```
...
```clojure
:dependencies [[joplin.cassandra "0.2.18"]
               [joplin.datomic "0.2.18"]
               [joplin.elasticsearch "0.2.18"]
               [joplin.hive "0.2.18"]
               [joplin.jdbc "0.2.18"]
               [joplin.zookeeper "0.2.18"]]
```
