...
```clojure
:dependencies [[joplin.core "0.2.11"]]
```

If you want to integrate Joplin into Leiningen:

```clojure
:plugins [[joplin.lein "0.2.11"]]
```
...
```clojure
:dependencies [[joplin.cassandra "0.2.11"]
               [joplin.datomic "0.2.11"]
               [joplin.elasticsearch "0.2.11"]
               [joplin.hive "0.2.11"]
               [joplin.jdbc "0.2.11"]
               [joplin.zookeeper "0.2.11"]]
```
