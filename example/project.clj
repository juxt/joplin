(defproject joplin-example "0.3.7-SNAPSHOT"
  :dependencies [[org.clojure/clojure "1.7.0"]
                 [joplin.core "0.3.7-SNAPSHOT"]
                 [joplin.jdbc "0.3.7-SNAPSHOT"]
                 [com.h2database/h2 "1.4.188"]
                 [org.postgresql/postgresql "9.4-1201-jdbc4"]
                 [joplin.cassandra "0.3.7-SNAPSHOT"]
                 [joplin.dynamodb "0.3.7-SNAPSHOT"]
                 [joplin.zookeeper "0.3.7-SNAPSHOT"]
                 [joplin.elasticsearch "0.3.7-SNAPSHOT"]
                 [joplin.datomic "0.3.7-SNAPSHOT" :exclusions [joda-time]]
                 [joplin.hive "0.3.7-SNAPSHOT"]
                 ]
