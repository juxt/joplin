(defproject joplin "0.2.1-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.6.0"]
                 [joplin.core "0.2.1-SNAPSHOT"]
                 [joplin.jdbc "0.2.1-SNAPSHOT"]
                 [joplin.elasticsearch "0.2.1-SNAPSHOT"]
                 [joplin.zookeeper "0.2.1-SNAPSHOT"]
                 [joplin.datomic "0.2.1-SNAPSHOT"]
                 [joplin.cassandra "0.2.1-SNAPSHOT"]
