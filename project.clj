(defproject joplin "0.1.9-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.6.0"]
                 [joplin.core "0.1.9-SNAPSHOT"]
                 [joplin.jdbc "0.1.9-SNAPSHOT"]
                 [joplin.elasticsearch "0.1.9-SNAPSHOT"]
                 [joplin.zookeeper "0.1.9-SNAPSHOT"]
                 [joplin.datomic "0.1.9-SNAPSHOT"]
                 [joplin.cassandra "0.1.9-SNAPSHOT"]
                 [ragtime "0.3.6"]]
